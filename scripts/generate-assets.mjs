#!/usr/bin/env node
/**
 * Generates every brand asset for MineStreak from one source of truth: the mark below.
 *
 ...
 */
const SHAPES = [{"type":"path","points":[[0.7,0.5],[0.97,0.5]],"w":0.085,"fill":"accent"},{"type":"path","points":[[0.6414213562373096,0.6414213562373094],[0.8323401871576773,0.8323401871576772]],"w":0.085,"fill":"accent"},{"type":"path","points":[[0.5,0.7],[0.5,0.97]],"w":0.085,"fill":"accent"},{"type":"path","points":[[0.3585786437626905,0.6414213562373096],[0.16765981284232273,0.8323401871576773]],"w":0.085,"fill":"accent"},{"type":"path","points":[[0.3,0.5],[0.030000000000000027,0.5000000000000001]],"w":0.085,"fill":"accent"},{"type":"path","points":[[0.35857864376269044,0.3585786437626905],[0.16765981284232262,0.16765981284232273]],"w":0.085,"fill":"accent"},{"type":"path","points":[[0.49999999999999994,0.3],[0.4999999999999999,0.030000000000000027]],"w":0.085,"fill":"accent"},{"type":"path","points":[[0.6414213562373094,0.35857864376269044],[0.8323401871576772,0.16765981284232262]],"w":0.085,"fill":"accent"},{"type":"circle","cx":0.5,"cy":0.5,"r":0.27,"fill":"accent"},{"type":"circle","cx":0.41,"cy":0.41,"r":0.075,"fill":"ink"}];
 ...
 */
const MARK = [[0.12,0.45,1,0.45,0.12],[0.45,1,1,1,0.45],[1,1,1,1,1],[0.45,1,1,1,0.45],[0.12,0.45,1,0.45,0.12]];
...
console.log('Generating MineStreak brand assets\n');
