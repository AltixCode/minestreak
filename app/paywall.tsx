...
const BENEFITS = ["The full board archive and every difficulty","No ads, ever","Unlimited hints — always a deducible next move","Detailed streak, time and efficiency stats"];
  ...
  return (
    <View style={{ flex: 1, backgroundColor: colors.background, paddingTop: insets.top }}>
      ...
      <ScrollView contentContainerStyle={{ padding: spacing.xl, paddingBottom: spacing['3xl'] }}>
        <Text variant="display">MineStreak Pro</Text>
        <Text variant="body" tone="muted" style={{ marginTop: spacing.sm }}>
          One fair minesweeper board a day. Never a 50/50 guess.
        </Text>
